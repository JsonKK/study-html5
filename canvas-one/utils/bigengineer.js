/*
名称：金海龙HTML5 Canvas 作图函数库 2012版
版本：2.0
作者：金海龙(天主教)
博客：http://bigengineer.blog.51cto.com/
Google搜索：AI编程集团 金蝉脱壳的博客
类型：Web应用/绘图/源代码
...
function DrawAOBArc(Canvas, A, O, B, Radius) {
  ...
  */
  ...
  {
    Canvas.moveTo(A[0], A[1]);
    Canvas.arcTo(O[0], O[1], B[0], B[1], Radius);
    Canvas.lineTo(B[0], B[1]);
  }
}
...
function DrawQuadraticCurveTo(Canvas, A, O, B) {
  ...
  {
    Canvas.moveTo(A[0], A[1]);
    Canvas.bezierCurveTo(A[0], A[1], O[0], O[1], B[0], B[1]);
  }
}
...
function DrawbezierCurveTo(Canvas, A, O1, O2, B) {
  ...
  {
    Canvas.moveTo(A[0], A[1]);
    Canvas.bezierCurveTo(O1[0], O1[1], O2[0], O2[1], B[0], B[1]);
  }
}
